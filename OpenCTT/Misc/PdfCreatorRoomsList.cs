...
namespace OpenCTT
{
    class PdfCreatorRoomsList
    {
        ...
        static int[] COL_WIDTH = new int[3] { 185, 105, 85};
        static int CURR_Y = Y_START;
        static int ROW_HEIGHT = 14;

        static PdfCreatorRoomsList()
        {
            if (RES_MANAGER == null)
            {
                RES_MANAGER = new System.Resources.ResourceManager("OpenCTT.MyStrings.OCTTDocument", typeof(OCTTDocument).Assembly);
            }
        }

        public static void createPdfDocumentRoomsList()
        {
            CURR_Y = Y_START;
            PAGE_COUNTER = 0;
            TOTAL_PAGE_NUMBER = 0;
            ...
            string fileName = "ReportRoomsList" +".pdf";

            PDFDOCUMENT = new PdfDocument();
            PDFDOCUMENT.Info.Title = "OCTT Rooms List Report";
            ...
            double dab = System.Convert.ToDouble(AppForm.CURR_OCTT_DOC.RoomsRootNode.Nodes.Count / 34.0);
        ...
        private static void createPageHeader(XGraphics gfx)
        {
            ...
            string reportName = RES_MANAGER.GetString("rooms_list");
