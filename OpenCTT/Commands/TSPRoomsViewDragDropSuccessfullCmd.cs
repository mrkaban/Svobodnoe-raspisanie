...
{
	/// <summary>
	/// Summary description for TSPRoomsViewDragDropSuccessfullCmd.
	/// </summary>
	public class TSPRoomsViewDragDropSuccessfullCmd:AbstractCommand
	{
		...
		public TSPRoomsViewDragDropSuccessfullCmd(Course dragedCourse,TimeSlotPanel tsp,ArrayList lessonsInOneTimeSlot, Object [] courseAndRoomPair)
		{
