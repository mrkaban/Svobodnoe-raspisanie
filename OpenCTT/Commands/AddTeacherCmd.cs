...
{
	/// <summary>
	/// Summary description for AddTeacherCmd.
	/// </summary>
	public class AddTeacherCmd:AbstractCommand
	{
		private Teacher _teacher;

		public AddTeacherCmd(string name, string lastName,string title, string eduRank, string extID)
		{
			_teacher = new Teacher(name, lastName, title, eduRank, extID);
		}
